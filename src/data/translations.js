...
const UI_STRINGS = {
  ...
  el: {
    ...
    switchLang: 'English',
    helpTitle: 'Πώς να χρησιμοποιήσετε τον PXD κήπο',
    helpIntro: 'Ο PXD κήπος είναι ένας διαδραστικός σχεδιαστής συντροφικής φύτευσης. Δείτε πώς να το χρησιμοποιήσετε:',
